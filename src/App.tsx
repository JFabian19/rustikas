...
export default function App() {
  ...
  const sendToWhatsApp = () => {
    ...
    const logistics = fulfillment === 'delivery' ? `*ENTREGA*\n🛵 Delivery\n👤 ${customer.name}\n📍 ${customer.address}${customer.reference.trim() ? `\n🏷️ Ref.: ${customer.reference}` : ''}${location ? `\n🗺️ Ubicación: https://www.google.com/maps?q=${location.latitude},${location.longitude}` : ''}` : `*ENTREGA*\n🛍️ Recoger en tienda\n👤 ${customer.name}\n📞 ${customer.phone}`;
